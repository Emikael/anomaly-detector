package com.emikaelsilveira.anomalydetector.producer.actuator;
...
class ProducerActuatorIT {
    ...
    @Test
    void exposesOnlyOperationalEndpoints() throws Exception {
        assertOperationalEndpoint("/actuator/health");
        assertOperationalEndpoint("/actuator/info");
        assertOperationalEndpoint("/actuator/prometheus");
