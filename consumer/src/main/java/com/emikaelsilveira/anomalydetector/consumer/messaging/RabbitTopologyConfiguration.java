...
/**
 * Declares the durable topology, separately from the listener and conversion concerns in
 * {@link RabbitConfiguration}.
 *
 * <p>Split out because this class is deliberately identical to the producer's copy: either service
